          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full space-y-12">
            <div className="flex items-center justify-between border-b border-zinc-800 pb-4">
              ...
              <div className="hidden md:flex flex-col items-end">
                <span className="text-[10px] text-zinc-500 font-black uppercase tracking-[0.2em]">Concurrent Multilingual Stack</span>
                <span className="text-[9px] text-zinc-700 font-mono">Parallel Sync Active</span>
              </div>
            </div>
                  ...
                  {ASPECT_RATIOS.map((ratio) => (
                    ...
                    >
                      <div className="flex items-center justify-between px-1 text-zinc-500">
                        <span className="text-[11px] font-black uppercase tracking-[0.25em] group-hover:text-red-500 transition-colors">{ratio.name}</span>
                        <span className="text-[10px] font-mono tracking-tighter">{ratio.width} × {ratio.height}</span>
                      </div>
